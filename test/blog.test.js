...
describe('When logged in', () => {
    ...
    describe('And using valid inputs', () => {
        ...
        test('Submmiting takes user to review screen', async () => {
            const test = await page.getContentsOf('h5');
            expect(test).toEqual('Please confirm your entries');
        });

        test('Submmiting then saving adds blogs to index page', async () => {
